...
public class Course2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("平均值："+average(new int[] { 1, 2, 3, 4, 5, 6, 7 }));
        System.out.println("=================================");

        System.out.println("旋转数组："+Arrays.toString(rotate(new int[] { 1, 2, 3, 4, 5 },3 )));
        System.out.println("=================================");

        System.out.println("旋转数组："+Arrays.toString(rotate(new int[] { 1, 2, 3, 4, 5 },8 )));
        System.out.println("=================================");

        System.out.println("旋转数组："+Arrays.toString(rotate(new int[] { 1, 2, 3, 4, 5, 6, 7 }, 8)));
        System.out.println("=================================");

        System.out.println(Arrays.toString(partition1(new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9})));
        System.out.println("=================================");
